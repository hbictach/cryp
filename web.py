...
def sitemap_xml():
    ...
    urls = [
        ...
        url_for("home", tab="bitcoin", _external=True),
        url_for("home", tab="ethereum", _external=True),
        url_for("home", tab="defi", _external=True),
        url_for("home", tab="nft", _external=True),
    ]
    body = "".join(
